...
% \end{minipage}
\newpage
\lstinputlisting[language={[latex]tex},gobble=4,numbers=none,caption={},frame=lines,firstline=2]{tests/test-default.tex}
\includepdf[frame,width=\textwidth,pages=-]{tests/test-default.pdf}
\newpage
\begin{raggedright}
...
\end{minipage}
\newpage
\includepdf[frame,width=\textwidth,pages=-]{tests/test-default-hide-after.pdf}
\newpage
  \begin{raggedright}
...
\end{lstlisting}
\end{minipage}
\includepdf[frame,width=\textwidth,pages=-]{tests/test-default-hide-before.pdf}
\newpage
  \begin{raggedright}
...
\end{lstlisting}
\end{minipage}
\includepdf[frame,width=\textwidth,pages=-]{tests/test-todonotes.pdf}
\newpage
  \begin{raggedright}
    With option \verb|pretty|\\[2em]
  \end{raggedright}
\par\noindent%
\begin{minipage}{\textwidth}
\begin{lstlisting}[language={[latex]tex},gobble=4,frame=lines,caption={},numbers=none]
...
\end{lstlisting}
\end{minipage}
\includepdf[frame,width=\textwidth,pages=-]{tests/test-pretty.pdf}
\end{center}
\end{document}
%%% Local Variables:
%%% mode: latex
